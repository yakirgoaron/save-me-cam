...
public class Query extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Queryevents extends QueryRequest<com.cam.UI.server.EventsForUserCollection> {
    ...
    protected Queryevents(java.lang.String userName) {
      super(Query.this, "POST", REST_PATH, null, com.cam.UI.server.EventsForUserCollection.class);
